...
const socialLinks = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/techifyapps",
    icon: (
...
export default function FooterCta() {
  ...
  const paths = [
    {
      id: "line-main",
      d: "M 250 75 C 140 20, 60 80, 10 155",
      stroke: "#1e1a12",
      strokeWidth: 1.5,
      dasharray: "none",
      opacity: 0.5,
    ...
    {
      id: "line-secondary",
      d: "M 255 95 C 160 40, 80 100, 30 160",
      stroke: "#c88b2a",
      strokeWidth: 1,
      dasharray: "3 7",
      opacity: 0.55,
    ...
    {
      id: "line-tertiary",
      d: "M 248 58 C 130 10, 55 60, 5 145",
      stroke: "#1e1a12",
      strokeWidth: 0.8,
      dasharray: "1 9",
      opacity: 0.2,
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="relative">
          ...
          >
            ...
            <EndpointPulse x={10} y={155} delay={1.6} inView={inView} color="#c88b2a" />
