...
export default function EndToEndSection() {
  ...
  return (
    <section className="bg-white py-20">
      <div className="max-w-6xl mx-auto px-6 grid gap-12 md:grid-cols-[0.95fr_1.05fr] items-center">
        <motion.div
        ...
        >
          ...
          <p className="text-[0.95rem] text-[#5f5a52] leading-relaxed">
            We handle everything from strategy and design to development, deployment, and long-term
            support.
          </p>
